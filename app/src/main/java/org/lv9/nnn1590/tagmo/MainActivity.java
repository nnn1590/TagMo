...
import org.lv9.nnn1590.tagmo.ptag.PTagKeyManager;
...
public class MainActivity extends AppCompatActivity {
    ...
    void loadPTagKeyManager() {
        ...
        try {
            ...
            e.printStackTrace();
            showToast(getString(R.string.failed_to_load_powertag_keys));
        }
    }
    ...
    void loadAmiiboManagerTask() {
        ...
        try {
            ...
            e.printStackTrace();
            showToast(getString(R.string.unable_to_parse_amiibo_info));
        }
    ...
    void loadTagFile() {
        if (prefs.enableAmiiboBrowser().get()) {
            ...
            showFileChooser(getString(R.string.load_encrypted_tag_file_for_writing), "*/*", FILE_LOAD_TAG);
        }
    }
    ...
    void writeToTagRaw() {
        if (this.currentTagData == null) {
            LogError(getString(R.string.log_no_tag_loaded));
            return;
        }
        if (!this.keyManager.hasBothKeys()) {
            LogError(getString(R.string.log_keys_not_loaded));
            return;
        }
        Intent intent = new Intent(this, NfcActivity_.class);
    ...
    void startQRActivity(Intent intent, int resultCode) {
        if (intent.resolveActivity(getPackageManager()) != null) {
            ...
            new AlertDialog.Builder(this)
                .setMessage(R.string.barcode_scanner_not_found_would_you_like_to_install_it)
                .setPositiveButton(getString(R.string.barcode_non_yes), new DialogInterface.OnClickListener() {
                    @Override
                ...
                .setNegativeButton(getString(R.string.barcode_non_no), null)
                .show();
        }
    }
    ...
    void loadQRCode(String content) {
        ...
        try {
            ...
            Log.e(TAG, getString(R.string.qr_base64_decode_fail), e);
            data = null;
        }
        if (data == null) {
            try {
                ...
                Log.e(TAG, getString(R.string.qr_legacy_decode_fail), e);
                data = null;
            }
        }

        if (data == null) {
            showToast(getString(R.string.qr_decode_fail));
            return;
        }
    ...
    void onEditTagResult(int resultCode, Intent data) {
        ...
        if (this.currentTagData == null) {
            LogError(getString(R.string.log_tag_data_is_empty));
        }
    }
    ...
    private void showFileChooser(String title, String mimeType, int resultCode) {
        ...
        try {
            ...
            LogError(getString(R.string.log_fail_open_fm));
    ...
    void loadTagFile(Uri uri) {
        try {
            ...
            LogError(getString(R.string.log_error) + e.getMessage());
        }
    ...
    protected void writeTagToFile(byte[] tagdata) {
        ...
        try {
            ...
            LogError(getString(R.string.log_tag_is_not_valid));
        }
        ...
        try {
            ...
            LogMessage(getString(R.string.log_wrote_to_file) + fileName + getString(R.string.log_in_tagmo_directory));
        } catch (Exception e) {
            LogError(getString(R.string.log_error_writeing_to_file) + e.getMessage());
        }
    }
    ...
    void dumpLogCat() {
        try {
            ...
            LogMessage(getString(R.string.log_wrote_to_file) + fName + getString(R.string.log_in_tagmo_directory));
        } catch (Exception e) {
            LogError(getString(R.string.log_error_writing_to_file) + e.getMessage());
        }
    }
