...
public class HexViewerActivity extends AppCompatActivity {
    ...
    static TagMap[] tagMap = new TagMap[] {
        new TagMap(0x1E4, Color.LTGRAY, MyApplication.getContext().getResources().getString(R.string.crypto_seed)),
        new TagMap(0x1DC, Color.WHITE, MyApplication.getContext().getResources().getString(R.string.char_id)),
        new TagMap(0x1D4, Color.RED, MyApplication.getContext().getResources().getString(R.string.ntag_uid)),
        new TagMap(0x1B4, Color.LTGRAY, MyApplication.getContext().getResources().getString(R.string.tag_hmac)),
        new TagMap(0xDC, Color.CYAN, MyApplication.getContext().getResources().getString(R.string.app_data)),
        new TagMap(0xBC, Color.LTGRAY, MyApplication.getContext().getResources().getString(R.string.hash)),
        new TagMap(0xAC, Color.GRAY, MyApplication.getContext().getResources().getString(R.string.app_id)),
        new TagMap(0x4C, Color.GREEN, MyApplication.getContext().getResources().getString(R.string.mii)),
        new TagMap(0x38, Color.BLUE, MyApplication.getContext().getResources().getString(R.string.nickname)),
        new TagMap(0x34, Color.YELLOW, MyApplication.getContext().getResources().getString(R.string.console_hash)),
        new TagMap(0x28, Color.YELLOW, MyApplication.getContext().getResources().getString(R.string.timestamp_counter)),
        new TagMap(0x08, Color.LTGRAY, MyApplication.getContext().getResources().getString(R.string.data_hmac)),
        new TagMap(0x00, Color.GRAY, MyApplication.getContext().getResources().getString(R.string.lock_cc)),
    };
