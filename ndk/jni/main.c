...
JNIEXPORT jint Java_org_lv9_nnn1590_tagmo_AmiiTool_setKeysUnfixed(JNIEnv * env, jobject this, jbyteArray keydata, jint dataLength) {
...
JNIEXPORT jint Java_org_lv9_nnn1590_tagmo_AmiiTool_setKeysFixed(JNIEnv * env, jobject this, jbyteArray keydata, jint dataLength) {
...
JNIEXPORT jint Java_org_lv9_nnn1590_tagmo_AmiiTool_unpack(JNIEnv * env, jobject this, jbyteArray tag, jint dataLength, jbyteArray returnData, jint returnDataLength) {
...
JNIEXPORT jint Java_org_lv9_nnn1590_tagmo_AmiiTool_pack(JNIEnv * env, jobject this, jbyteArray tag, jint dataLength, jbyteArray returnData, jint returnDataLength) {
